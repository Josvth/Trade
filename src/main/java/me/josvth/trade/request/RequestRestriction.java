...
public enum RequestRestriction {
	...
	CROSSGAMEMODE ("trade.allow.cross-game-mode", "requesting.restriction.cross-game-mode", "trading.restriction.cross-game-mode"),
	CROSSWORLD ("trade.allow.cross-world", "requesting.restriction.cross-world", "trading.restriction.cross-world"),
